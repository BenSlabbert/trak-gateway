...
docker push benjaminslabbert/trak_gateway:"${VERSION}" benjaminslabbert/trak_gateway:latest
docker push benjaminslabbert/trak_worker:"${VERSION}" benjaminslabbert/trak_worker:latest
docker push benjaminslabbert/trak_search:"${VERSION}" benjaminslabbert/trak_search:latest
